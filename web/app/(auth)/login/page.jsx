...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log("Email sign-in successful. Fetching user role from Firestore...");
      
      const userDoc = await getDoc(doc(db, "users", userCredential.user.uid));
      console.log("Firestore doc fetched:", userDoc.exists());
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log("Google sign-in successful. Fetching user role from Firestore...");
      ...
      if (userDoc.exists()) {
        ...
        // Let's create it dynamically with a default role of "citizen".
        console.log("Creating missing user profile for Google user...");
        await import("firebase/firestore").then(({ setDoc }) => {
          return setDoc(doc(db, "users", userCredential.user.uid), {
            uid: userCredential.user.uid,
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500">Sign in to continue to HospiConnect</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-blue-600 text-white rounded-xl py-4 font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-200 disabled:opacity-50 mt-4"
          >
